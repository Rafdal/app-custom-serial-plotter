...
class App(QMainWindow):
    ...
    def initUI(self):
        # set models
        self.serial_handler = SerialPortsHandler()
        ...
        # Settings Popup
        self.port_settings_popup = v.PortSetupPopup(self.serial_handler)
        ...
        # TABS
        consoleTab = v.ConsolePrintTab(self.serial_handler, self.plot_data)
    ...
    def scan_ports(self):
        ...
        ports = self.serial_handler.port_list()
        self.port_selector.addItems(ports)

    def open_port(self):
        try:
            self.serial_handler.port = self.port_selector.currentText()
